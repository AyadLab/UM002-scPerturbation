# Run CytoTRACE on obj dataset
#   # we need an expression matrix and a pheno table similiar to the input for infercnv

# if (!requireNamespace("BiocManager", quietly = TRUE))
#     install.packages("BiocManager")
# BiocManager::install("infercnv")
# install.packages("devtools")
# devtools::install_github("satijalab/objat", ref = "develop")
...
# reference normal cell group names in a vector
# ref_vector <- c("Myeloid", "Astrocytes", "T-Cells", "Endothelial", "Oligodendrocytes", "Fibroblasts")
...
# FeaturePlot(obj, features = c("CytoTRACErank"), cols = viridis(256, option = "D"), reduction = "umap")
FeaturePlot(obj, features = c("CytoTRACE"), cols = viridis(256, option = "D"), reduction = "umap") + NoLegend()
# FeaturePlot(obj, features = c("CytoTRACErank"), cols = viridis(256, option = "D"), reduction = "umap") + NoLegend()
